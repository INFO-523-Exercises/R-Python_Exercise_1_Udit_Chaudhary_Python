# -*- coding: utf-8 -*-
"""R/Python_Exercise_1(Part 2).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1jfHtK9-e-xEM-oOJF_HlPHeEdAI8RVQ3
...
oneDim = np.array([2.0,4,1,3,5])   # a 1-dimensional array (vector)
print(oneDim)
...
#There are several methods for choosing a subset of elements from a numpy array.
#A reference to a numpy array (or a subset of its components) will be sent to another variable in place of duplicating the array's values.
#The .copy() method must be explicitly called in order to duplicate an ndarray.
...
#An ndarray's components can be accessed in a variety of ways.
...
#Series and DataFrame are two practical data structures that Pandas offers for the storage and manipulation of data.
#A DataFrame is a tabular form similar to a spreadsheet table, but a Series is comparable to a one-dimensional array.

"""####Series"""

#The elements of a Series object's one-dimensional array of values may be found using an index array.
#From a list, a numpy array, or a Python dictionary, a Series object may be made.
#The majority of numpy functions may be used on the Series object.
...
#There are various functions available to find the number of elements in a Series.
#Result of the function depends on whether null elements are included.
...
A DataFrame object is a tabular data structure that resembles a spreadsheet and has a number of columns, each of which can be of a variety of kinds (such as numeric, string, boolean, etc.). A DataFrame contains discrete row and column indexes in contrast to Series. A DataFrame object may be created in a variety of methods, such from a dictionary, list of tuples, or even numpy's ndarrays.
"""
